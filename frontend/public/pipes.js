...
import {ContextMenu, Viewer, XKTLoaderPlugin, Mesh, buildCylinderGeometry, buildSphereGeometry, PhongMaterial, ReadableGeometry, math, transformToNode} from "./xeokit-sdk.min.es.js";
...
const sceneModel = xktLoader.load({
    id: "myModel",
    src: "./Duplex_A_20110505.glTFEmbedded.xkt",
    edges: true
});
